...
// Contoh untuk menampilkan daftar tugas dengan opsi edit dan hapus
$sql = "SELECT * FROM tugas WHERE topik_id = ?";
    ...
    <tbody>
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td><a href="<?php echo htmlspecialchars($row['file_tugas']); ?>" download>Download File</a></td>
                <td>
